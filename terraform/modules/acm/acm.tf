...
resource "aws_acm_certificate_validation" "custom_domain_cert" {
    certificate_arn         = aws_acm_certificate.custom_domain_cert.arn
    validation_record_fqdns = [for record in aws_route53_record.custom_domain_cert_validation : record.fqdn]
}
